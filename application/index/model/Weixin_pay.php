...
class Weixin_pay extends model
{
	...
	public function __construct($appScrect="76254405af381c361034b42c6bc5df7c",$appId="wxc5fa30489f695602", $key="484139adminketangfufi484139admin",$mch_id ='1628996516'){
	...
	public function pay($openid,$total_fee,$body,$out_trade_no){
		  $config= config('wxpay');
		   ...
		   $url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
		   	$notify_url   ='https://huixinyinao.cn/index/requ/wxnotify';
    ...
    public function payh5($openid,$total_fee,$body,$out_trade_no){
          $config= config('wxpay');
            $ip= request()->ip();
        $url = "https://api.mch.weixin.qq.com/pay/unifiedorder";
        $notify_url   ='https://xieshouqg.com/index.php/wxpay/index/notify';
        ...
        // $data["openid"] = $openid;
        $data["scene_info"] = "{'h5_info': {'type':'Wap','wap_url':  $notify_url,'wap_name': '情感咨询'}}";
        $sign = $this->getSign($data);
         // halt($data);
        $data["sign"] = $sign;
