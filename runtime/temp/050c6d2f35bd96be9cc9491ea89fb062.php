<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:93:"/www/wwwroot/tb.youanfutang.cn/public/../application/admin/view/admin/table/webdatalogin.html";i:1715435756;s:65:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/layout.html";i:1658590062;s:70:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/base/header.html";i:1658677912;s:70:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/base/footer.html";i:1658590072;}*/ ?>
...
layui.use('table', function(){
   ...
   var ins1=table.render({
     ...
     ,height: 700
	 ,method:'post'
     ,url: '/login.php/admin/webdataloginlist' //数据接口
	...
	,request: {
     ...
     ,cols: [[ //表头
       ...
       ,{field: 'webip', title: `<?php echo $languageObj['登陆IP']['name_' . $language]; ?>`, width:100}
	    ,{field: 'ipnum', title: `<?php echo $languageObj['IP登陆次数']['name_' . $language]; ?>`, width:100}
       ,{field: 'logintime', title: `<?php echo $languageObj['登陆时间']['name_' . $language]; ?>`, width:180,}
       ,{field: 'name', title: `<?php echo $languageObj['登陆账号']['name_' . $language]; ?>`,width:100} 
       ,{field: 'jibie', title: `<?php echo $languageObj['账号级别']['name_' . $language]; ?>`, width:100}
