<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:94:"/www/wwwroot/tb.youanfutang.cn/public/../application/admin/view/admin/table_edi/upproduct.html";i:1715908315;s:65:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/layout.html";i:1658590062;s:70:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/base/header.html";i:1658677912;s:70:"/www/wwwroot/tb.youanfutang.cn/application/admin/view/base/footer.html";i:1658590072;}*/ ?>
...
<script type="text/javascript">
	...
	<div id="news_title">
		<span><?php echo $languageObj['产品标题']['name_' . $language]; ?>：</span>
		<input type="text" lay-verify="required" name="news_title" id="news_tit" value="" placeholder="" />
	</div>
	<div id="news_slt"><span><?php echo $languageObj['缩略图']['name_' . $language]; ?>：</span>
		<div style="float: left;"><img id="img_preview" src="/static/img/admin/news_slt.jpg"
				style="max-width: 300px;max-height: 120px"></div>
	</div>
...
<textarea rows="10" cols="50" id="news_jj">
	...
	<div class="taocan">
		...
		<div class="zwf"></div> <button class="layui-btn layui-bg-red edixh" type="button"><?php echo $languageObj['批量修改型号价格']['name_' . $language]; ?></button><input placeholder="批量价格" type="text" class="edixhnum layui-input" style="width:100px;display: inline-block;margin-left: 10px;" value="">
		<input id="fsmb" type="text" style="opacity: 0;">
	</div>
	<script type="text/javascript">
	...
	<div id="news_view"><span><?php echo $languageObj['产品价格']['name_' . $language]; ?>:</span><input type="text" class="layui-input" id="jiage"></div>

	<div id="news_time"><span><?php echo $languageObj['发布时间']['name_' . $language]; ?>:</span><input type="text" class="layui-input" id="newstime"></div>
    ...
    margin-bottom: 15px;
    display: inline-block;
    width: 90%;" type="text/plain" style=""></script>
	</div>



	<div id="news_sub"><button type="submit" id="news_submit" lay-submit lay-filter="submit"><?php echo $languageObj['提交保存']['name_' . $language]; ?></button></div>
</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$("#news_submit").click(function () {
			...
			if (!news_tit) {
				layer.msg(`<?php echo $languageObj['请填写产品标题！']['name_' . $language]; ?>`);
				$("#news_tit").addClass("danger");
				return false;
			}
			if ( !news_slt) {
				layer.msg(`<?php echo $languageObj['请上传缩略图']['name_' . $language]; ?>`);
				return false;
			}
			if ( !jiage) {
				layer.msg(`<?php echo $languageObj['请填写产品价格！']['name_' . $language]; ?>`);
				$("#jiage").addClass("danger");
				return false;
			}
			if ( !editor) {
				layer.msg(`<?php echo $languageObj['请填写产品介绍！']['name_' . $language]; ?>`);
				return false;
			}
